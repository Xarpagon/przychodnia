...
insert INTO USER (username, password, role_id, pesel, first_Name, last_name, street, house_number, postcode, city, country, phone_number, email_Address)values ('doctor1', '$2a$10$IPJizmA0rxJBq9incE/PWub6B2nIDGm3z/2cIz6hAs/hgvKlQ5F9q', 2, '50101044456', 'Andrew', 'Nowak', 'Kasztanowa', '34', '80600', 'Poznan', 'Poland', '+48790989900', 'andrew.nowak@wp.pl');
insert INTO USER (username, password, role_id, pesel, first_Name, last_name, street, house_number, postcode, city, country, phone_number, email_Address)values ('doctor2', '$2a$10$SgCjHGlv.exiSDwhQEUNfu3VxhRT7.jeKRs.HwfUy2UI/MjBdQtGO', 2, '40101044456', 'Arel', 'Nowaczyk', 'Kasztan', '12', '80630', 'Poznan', 'Poland', '+48790989911', 'arel.nowaczyk@wp.pl');
insert INTO USER (username, password, role_id, pesel, first_Name, last_name, street, house_number, postcode, city, country, phone_number, email_Address)values ('doctor3', '$2a$10$IPJizmA0rxJBq9incE/PWub6B2nIDGm3z/2cIz6hAs/hgvKlQ5F9q', 2, '6099999999', 'Janek', 'Kosynski', 'Janowiecka','13', '88-090', 'Rogowo','Poland','+48123456100','janek.kosynski@wp.pl');

Insert into DOCTOR (id,user_username, specialization, floor_Number, door_Number)values (nextval('doctor_Seq'), 'doctor1', 'UROLOGIST', '2', '12');
Insert into DOCTOR (id,user_username, specialization, floor_Number, door_Number)values (nextval('doctor_Seq'), 'doctor2', 'RADIOLOGIST', '1', '6');
Insert into DOCTOR (id,user_username, specialization, floor_Number, door_Number)values (nextval('doctor_Seq'), 'doctor3', 'HEMATOLOGIST', '1', '4');
